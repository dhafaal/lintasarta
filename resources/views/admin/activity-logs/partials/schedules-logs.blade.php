<div id="schedules-logs" class="tab-content">
    <div class="mb-4">
        <h3 class="mb-2 text-lg font-semibold text-gray-900">
            <i data-lucide="calendar" class="mr-2 inline h-5 w-5 text-emerald-600"></i>
    ...
    @if ($logs && $logs->count() > 0)
        <div class="space-y-4">
            @foreach ($logs as $log)
                <div class="rounded-lg border-l-4 border-emerald-500 bg-gray-50 p-4">
                    <div class="flex items-start justify-between">
                        ...
                        <div class="ml-4">
                            <button
                                onclick="toggleDetails('schedules-{{ $log->id }}')"
                    ...
                    <div id="schedules-{{ $log->id }}" class="mt-4 hidden border-t border-gray-200 pt-4">
...
{{ json_encode($log->new_values, JSON_PRETTY_PRINT) }}</pre
    ...
    @else
        <div class="py-12 text-center">
            ...
            <h3 class="mb-2 text-lg font-medium text-gray-900">No Schedules Logs Found</h3>
