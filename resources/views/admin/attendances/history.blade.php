            ...
            <div class="p-8">
                <form method="GET" action="{{ url()->current() }}" class="space-y-6">
                    ...
                    <div class="flex justify-center">
                        <button type="submit" class="inline-flex items-center px-8 py-3 bg-sky-600 hover:bg-sky-700 text-white font-bold rounded-xl transition-all transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-sky-200 shadow-lg hover:shadow-xl">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function clearHistoryUserSelection() {
            if (!historySearchValue || !historyUserSearchInput) return;
