                ...
                <div class="p-6">
                    <form action="{{ route('admin.locations.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div
                                class="space-y-2"
                                x-data="{ isActive: {{ old('is_active', 1) ? 'true' : 'false' }} }"
                            >
                                <label class="block text-sm font-semibold text-gray-700">
                                    <div class="flex items-center gap-2">
                                        <svg
                        ...
                        <div class="space-y-4">
                            <div class="space-y-2">
                                ...
                                <input type="number" name="radius" id="radius" class="@error('radius') border-red-500 @enderror block w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 focus:border-sky-500 focus:ring-2 focus:ring-sky-500" value="{{ old('radius', 100) }}" required placeholder="100" />
