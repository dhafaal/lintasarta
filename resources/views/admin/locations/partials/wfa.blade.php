    ...
    <tr>
        <td colspan="5" class="px-8 py-16 text-center">
            <div class="flex flex-col items-center">
                <div
                    class="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-purple-100 to-purple-200"
                >
                    <svg
                ...
                <h3 class="mb-2 text-xl font-bold text-gray-900">Belum ada lokasi WFA</h3>
                <p class="mb-6 max-w-sm text-gray-600">Mulai dengan menambahkan lokasi WFA untuk work from anywhere</p>
                <a
                    href="{{ route('admin.locations.create') }}"
                    class="inline-flex transform items-center rounded-xl bg-gradient-to-r from-purple-500 to-purple-600 px-6 py-3 font-bold text-white shadow-lg transition-all duration-200 hover:from-purple-600 hover:to-purple-700"
                >
...
@else
    @foreach ($items as $location)
        <tr class="group transition-colors duration-200 hover:bg-purple-50">
            <td class="px-4 py-6">
                <input
                    type="checkbox"
                    name="ids[]"
                    value="{{ $location->id }}"
                    class="row-select h-4 w-4 rounded border-gray-300 text-purple-600 focus:ring-purple-500"
                />
            </td>
            <td class="px-8 py-6 whitespace-nowrap">
                <div class="flex items-center">
                    <div
                        class="mr-4 flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-purple-100 to-purple-200 transition-colors group-hover:from-purple-200 group-hover:to-purple-300"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="20"
