...
@if($items->isEmpty())
    <tr>
        <td colspan="5" class="px-8 py-8 text-center text-gray-500">Belum ada lokasi WFA.</td>
    </tr>
@else
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <div class="text-xs mt-1">
                            <span class="px-2 py-0.5 rounded-full bg-purple-100 text-purple-700 font-medium">WFA</span>
