<div id="users-logs" class="tab-content">
    <div class="mb-6">
        <div class="flex items-center">
            ...
            <div class="ml-3">
                <h3 class="text-lg font-medium text-gray-900">Users Management Logs</h3>
                <p class="text-sm text-gray-500">Activities related to user creation, updates, and deletions</p>
            </div>
        </div>
    </div>
    ...
    @else
        <div class="text-center py-12">
            ...
            <h3 class="text-sm font-medium text-gray-900 mb-2">No Users Logs Found</h3>
            <p class="text-sm text-gray-500">No user management activities have been recorded yet.</p>
        </div>
    @endif
</div>
