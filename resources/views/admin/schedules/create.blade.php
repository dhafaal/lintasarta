    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-4 mb-3">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Tambah Schedule Baru</h1>
                    <p class="text-gray-600 mt-1">Buat jadwal kerja baru untuk karyawan</p>
                </div>
            </div>
            <nav class="flex items-center space-x-2 text-sm text-gray-500">
                ...
                <span class="text-gray-900 font-medium">Tambah Schedule</span>
            </nav>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-sky-500 to-sky-600 px-8 py-6">
                <h2 class="text-xl font-semibold text-white">Informasi Schedule</h2>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-8 border-t border-gray-200">
                        ...
                        >
                            <span class="flex items-center justify-center gap-3">
                                ...
                                <span id="submitText">Simpan Schedule</span>
