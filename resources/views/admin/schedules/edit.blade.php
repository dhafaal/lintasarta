                        ...
                        <p class="text-sm text-gray-500">
                            @if (isset($isBulkEdit) && $isBulkEdit)
                                @if (isset($selectedUser))
                                    Edit jadwal bulanan untuk {{ $selectedUser->name }} dengan mengubah informasi di
                                    bawah ini
                                @else
                                        Edit jadwal bulanan dengan mengubah informasi di bawah ini
                                @endif
                            @else
                                Edit jadwal bulanan untuk {{ $schedule->user->name }} dengan mengubah informasi di
                                bawah ini
                            @endif
                        </p>
                    </div>
        ...
        <div class="mx-auto px-6 py-6">
            ...
            <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                ...
                <div class="p-6">
                    ...
                    <form
                        action="{{ isset($isBulkEdit) && $isBulkEdit ? route('admin.schedules.update', 'bulk') : route('admin.schedules.update', $schedule) }}"
                        method="POST"
                        class="space-y-6"
                        id="scheduleForm"
                    >
                            ...
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div class="relative">
                                    <select
                                        id="calendarMonth"
                                        name="month"
                                        class="block w-full cursor-pointer rounded-lg border border-gray-300 bg-white px-4 py-2.5 focus:border-sky-500 focus:ring-2 focus:ring-sky-500"
                                        required
                                    >
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                @if (isset($isBulkEdit) && $isBulkEdit)
                                    @if (isset($selectedUser))
                                        <div
                                            class="block w-full rounded-lg border border-sky-300 bg-sky-50 px-4 py-2.5 font-medium text-gray-900"
                                        >
                                            {{ $selectedUser->name }}
                                        </div>
                        ...
                        <div class="space-y-2">
                            <div class="text-xs font-medium text-gray-500">Kontrol:</div>
                            <div class="flex flex-wrap gap-2">
                                <button
                                    type="button"
                                    class="rounded-lg bg-red-50 px-3 py-1.5 text-sm font-medium text-red-600 transition-colors duration-200 hover:bg-red-100"
                                    onclick="clearPreset()"
                                >
                                    Kosongkan Semua
                                </button>
                        ...
                        <div class="flex flex-col gap-3 border-t border-gray-200 pt-6 sm:flex-row">
                            <button
                                type="submit"
                                class="inline-flex flex-1 items-center justify-center gap-2 rounded-lg bg-sky-500 px-6 py-2.5 font-semibold text-white transition-colors duration-200 hover:bg-sky-600 focus:ring-4 focus:ring-sky-200 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
                                id="submitBtn"
                            >
                        ...
                        <!-- Validation Alert -->
                        <div id="validationAlert" class="mt-4 hidden rounded-lg border border-red-200 bg-red-50 p-4">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm text-red-700" id="validationMessage"></span>
                            </div>
                        </div>
                    </form>
                </div>
