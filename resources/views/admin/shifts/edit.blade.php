    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-4 mb-3">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Edit Shift</h1>
                    <p class="text-gray-600 mt-1">Perbarui informasi shift {{ $shift->name }}</p>
                </div>
            </div>
            <nav class="flex items-center space-x-2 text-sm text-gray-500">
                ...
                <span class="text-gray-900 font-medium">Edit {{ $shift->name }}</span>
            </nav>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div class="p-8">
                <form action="{{ route('admin.shifts.update', $shift) }}" method="POST" class="space-y-8" id="shiftEditForm">
                    @csrf 
                    @method('PUT')
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative group">
                            ...
                            <select 
                                ...
                                required
                            >
                                <option value="Pagi" @if($shift->name=='Pagi') selected @endif>Pagi</option>
                                <option value="Siang" @if($shift->name=='Siang') selected @endif>Siang</option>
                                <option value="Malam" @if($shift->name=='Malam') selected @endif>Malam</option>
                            </select>
