                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">
                            Buat akun pengguna baru dengan mengisi informasi di bawah ini
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                <div class="border-b border-gray-200 bg-gradient-to-r from-sky-50 to-blue-50 px-6 py-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-lg font-bold text-gray-800">Informasi User</h2>
                    ...
                    <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-6" id="userForm">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    id="name"
                                    name="name"
                                    class="block w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 transition-all duration-200 focus:border-sky-500 focus:ring-2 focus:ring-sky-500"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="rounded-lg border border-sky-200 bg-sky-50 p-3">
                                <p class="mb-2 text-xs font-medium text-sky-800">NOTE</p>
                                <ul class="space-y-1 text-xs text-sky-700">
                                    <li class="flex items-center gap-1">
                                        ...
                                        Password akan otomatis terisi =
                                        <span class="font-bold">Password123</span>
                                    </li>
                                    <li class="flex items-center gap-1">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
