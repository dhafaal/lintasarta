            ...
            <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                <div class="border-b border-gray-200 bg-gradient-to-r from-sky-50 to-blue-50 px-6 py-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-lg font-bold text-gray-800">Edit Informasi User</h2>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    class="@error('email') @enderror block w-full rounded-lg border border-gray-300 border-red-500 bg-white px-4 py-2.5 transition-all duration-200 focus:border-sky-500 focus:ring-2 focus:ring-sky-500"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    name="password"
                                    id="password"
                                    class="@error('password') @enderror block w-full rounded-lg border border-gray-300 border-red-500 bg-white px-4 py-2.5 transition-all duration-200 focus:border-sky-500 focus:ring-2 focus:ring-sky-500"
                            ...
                            <div
                                class="flex items-center gap-2 rounded-lg border border-amber-200 bg-amber-50 p-3 text-xs text-amber-800"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="14"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <select
                                    name="role"
                                    id="role"
                                    class="@error('role') @enderror block w-full cursor-pointer rounded-lg border border-gray-300 border-red-500 bg-white px-4 py-2.5 transition-all duration-200 focus:border-sky-500 focus:ring-2 focus:ring-sky-500"
                                    required
                                >
                                    @php
