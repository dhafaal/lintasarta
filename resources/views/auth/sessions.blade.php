        ...
        <div class="mx-auto max-w-4xl space-y-8">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    <div
                        class="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-green-100 to-green-200 shadow-sm"
                    >
                        <svg
                    ...
                    <div>
                        <h1 class="text-3xl font-bold tracking-tight text-gray-900">Active Sessions</h1>
                        <p class="mt-1 text-gray-500">Manage your active login sessions and devices</p>
                    </div>
                </div>
                <button
                    onclick="refreshSessions()"
                    class="inline-flex transform items-center rounded-xl border border-gray-200 bg-white px-4 py-2 font-semibold text-gray-700 shadow-lg transition-all duration-200 hover:bg-gray-50 hover:shadow-xl focus:ring-4 focus:ring-gray-200 focus:outline-none"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
            ...
            <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-xl">
                <div class="border-b border-gray-100 bg-gradient-to-r from-green-50 to-blue-50 px-8 py-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-xl font-semibold text-gray-900">Your Active Sessions</h2>
                            <p class="mt-1 text-gray-600">Sessions active in the last 2 hours</p>
                        </div>
                        <button
                ...
                <div id="sessionsContainer" class="p-8">
                    <div class="flex items-center justify-center py-12">
                        <svg class="mr-3 h-8 w-8 animate-spin text-gray-400" fill="none" viewBox="0 0 24 24">
                            <circle
                                class="opacity-25"
                                cx="12"
                                cy="12"
            ...
            <!-- Remember Me Tokens -->
            <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-xl">
                <div class="border-b border-gray-100 bg-gradient-to-r from-purple-50 to-pink-50 px-8 py-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-xl font-semibold text-gray-900">Remember Me Devices</h2>
                            <p class="mt-1 text-gray-600">Devices with active "Remember Me" tokens</p>
                        </div>
                        <button
                            onclick="revokeAllTokens()"
                            class="inline-flex items-center rounded-lg bg-purple-100 px-4 py-2 text-sm font-semibold text-purple-700 transition-all duration-200 hover:bg-purple-200"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
