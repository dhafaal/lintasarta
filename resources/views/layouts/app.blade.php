...
<body class="min-h-screen bg-radial from-sky-200 via-sky-100 to-white antialiased">
    <div class="flex min-h-screen" x-data="{
            ...
            <nav class="flex-1 space-y-2 p-3 overflow-y-auto" role="navigation">
                ...
                <a href="{{ route('admin.dashboard') }}"
                    ...
                    <i data-lucide="layout-dashboard" 
                       class="icon-hover w-6 h-6 icon-transition {{ request()->routeIs('admin.dashboard') ? 'text-sky-700' : 'text-gray-500 group-hover:text-sky-700' }}" 
                ...
                <div class="space-y-1 relative">
                    <button @click="sidebarCollapsed ? window.location.href = '{{ route('admin.users.index') }}' : toggleUsers()"
                        ...
                        <i data-lucide="users" 
                           class="icon-hover w-6 h-6 icon-transition {{ request()->routeIs('admin.users.*') ? 'text-sky-700' : 'text-gray-500 group-hover:text-sky-700' }}" 
                           :class="sidebarCollapsed ? 'mr-0' : 'mr-3'"></i>
                ...
                <div class="space-y-1 relative">
                    <button @click="sidebarCollapsed ? window.location.href = '{{ route('admin.schedules.index') }}' : toggleSchedules()"
                        ...
                        <i data-lucide="calendar" 
                           class="icon-hover w-6 h-6 icon-transition {{ request()->routeIs('admin.schedules.*') ? 'text-sky-700' : 'text-gray-500 group-hover:text-sky-700' }}" 
                           :class="sidebarCollapsed ? 'mr-0' : 'mr-3'"></i>
                    ...
                    <div x-show="schedulesExpanded && !sidebarCollapsed" 
                        ...
                        <a href="{{ route('admin.schedules.index') }}" 
                           class="group flex items-center px-3 py-2 text-sm font-semibold rounded-xl menu-item-transition {{ request()->routeIs('admin.schedules.index') ? 'bg-sky-100 text-sky-700' : 'text-gray-600 hover:bg-sky-100 hover:text-sky-700' }}">
                            <i data-lucide="calendar-days" class="w-4 h-4 mr-3 text-gray-500 group-hover:text-sky-700"></i>
                        ...
                        <a href="{{ route('admin.schedules.create') }}" 
                           class="group flex items-center px-3 py-2 text-sm font-semibold rounded-xl menu-item-transition {{ request()->routeIs('admin.schedules.create') ? 'bg-sky-100 text-sky-700' : 'text-gray-600 hover:bg-sky-100 hover:text-sky-700' }}">
                            <i data-lucide="calendar-plus" class="w-4 h-4 mr-3 text-gray-500 group-hover:text-sky-700"></i>
                ...
                <div class="space-y-1 relative">
                    <button @click="sidebarCollapsed ? window.location.href = '{{ route('admin.shifts.index') }}' : toggleShifts()"
                        ...
                        <i data-lucide="clock" 
                           class="icon-hover w-6 h-6 icon-transition {{ request()->routeIs('admin.shifts.*') ? 'text-sky-700' : 'text-gray-500 group-hover:text-sky-700' }}" 
                           :class="sidebarCollapsed ? 'mr-0' : 'mr-3'"></i>
                ...
                <a href="{{ route('admin.attendances.index') }}" 
                   ...
                   :aria-label="sidebarCollapsed ? 'Attendance' : ''">
                    <i data-lucide="user-check" 
                       class="icon-hover w-6 h-6 icon-transition {{ request()->routeIs('admin.attendances.*') ? 'text-sky-700' : 'text-gray-500 group-hover:text-sky-700' }}" 
                       :class="sidebarCollapsed ? 'mr-0' : 'mr-3'"></i>
                ...
                <a href="{{ route('admin.calendar.view') }}" 
                   ...
                   :aria-label="sidebarCollapsed ? 'Calendar' : ''">
                    <i data-lucide="calendar-range" 
                       class="icon-hover w-6 h-6 icon-transition {{ request()->routeIs('admin.calendar.view') ? 'text-sky-700' : 'text-gray-500 group-hover:text-sky-700' }}" 
                       :class="sidebarCollapsed ? 'mr-0' : 'mr-3'"></i>
        ...
        <div class="flex-1 flex flex-col min-h-screen sidebar-transition" 
                ...
                <div class="px-4 sm:px-6 py-4 flex justify-between items-center gap-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="text-base font-semibold text-gray-700 hidden sm:inline">{{ auth()->user()->name }}</span>
                        </div>
            ...
            <!-- Main Content -->
            <main class="flex-1 bg-radial from-sky-200 via-sky-100 to-white overflow-auto">
