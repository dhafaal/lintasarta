        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-200 transform transition-transform duration-300 ease-in-out lg:translate-x-0 shadow-lg"
            ...
            <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto custom-scrollbar">
                ...
                <a href="{{ route('user.dashboard') }}" 
                   class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg smooth-transition {{ request()->routeIs('user.dashboard') ? 'nav-active' : 'text-slate-700 hover:bg-slate-50' }}">
                    <i data-lucide="layout-dashboard" class="w-5 h-5 mr-3 {{ request()->routeIs('user.dashboard') ? 'text-sky-600' : 'text-slate-400' }}"></i>
                    <span>Dashboard</span>
                </a>
